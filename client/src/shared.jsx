import { lazy, Suspense, useEffect, useMemo, useRef, useState, Component } from 'react'

// Leaflet is ~150KB and only needed when a property map is actually on
// screen, so it loads as its own chunk instead of weighing down every page.
const LazyPropertyMap = lazy(() => import('./PropertyMap.jsx'))
