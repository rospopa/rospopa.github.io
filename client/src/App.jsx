        ...
        {tab === 'financials' && (
          <div className="space-y-4">
              ...
              <div className="space-y-3 pt-2">
                ...
                <Field label="Non-Recoverable Expense (%)">
